...
8. To pin the history item so that it remains on top of the list, press <kbd>OPTION (⌥)</kbd> + <kbd>P</kbd>. The item will be moved to the top with a numeric keyboard shortcut (e.g., <kbd>COMMAND (⌘)</kbd> + <kbd>1</kbd>, <kbd>COMMAND (⌘)</kbd> + <kbd>2</kbd>, etc.). To unpin it, press <kbd>OPTION (⌥)</kbd> + <kbd>P</kbd> again.
